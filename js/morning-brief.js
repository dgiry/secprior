// morning-brief.js — Morning Brief generator for SecPrior
//
...
const MorningBrief = (() => {
  ...
  function generate(articles, scopeDays) {
    ...
    L.push(`🛡️  SecPrior — Morning Brief`);
    ...
    // ── Footer ────────────────────────────────────────────────────────────────
    L.push('');
    L.push(`Generated by SecPrior · ${now.toISOString().slice(0, 16).replace('T', ' ')} UTC`);
