// quick-actions.js v9 — Actions rapides de sortie opérationnelle SecPrior
//
...
const QuickActions = (() => {
  ...
  function _ticketDraftText(entity, sourceType, nvdData) {
    ...
    const lines = [sep, 'SECURITY TICKET — SecPrior', sep, ''];
    ...
    lines.push(`  • Generated on ${_now()} · SecPrior`);
    lines.push('');
    lines.push(sep2);
  ...
  function _buildJiraUrl(entity, sourceType, nvdData) {
    ...
    d.push(`Generated by SecPrior — ${_now()}`);
  ...
  function _analystSummaryArticle(article, nvdData) {
    ...
    const lines = [sep, 'ANALYST SUMMARY — SecPrior', sep, ''];
  ...
  function _analystSummaryIncident(incident) {
    const sep  = '═'.repeat(48);
    const sep2 = '─'.repeat(48);
    const lines = [sep, 'INCIDENT REPORT — SecPrior', sep, ''];
  ...
  function _emailBriefArticle(article) {
    ...
    lines.push(sep);
    lines.push(`Auto-generated by SecPrior · ${_now()}`);
    ...
    return {
      ...
      _ticketStub: {
        ...
        description: [
          ...
          '',
          '---',
          `*Auto-generated by SecPrior on ${_now()}*`
