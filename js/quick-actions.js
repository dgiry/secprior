...
const QuickActions = (() => {
  ...
  function _ticketDraftText(entity, sourceType, nvdData) {
    ...
    const lines = [sep, 'SECURITY TICKET — ThreatLens', sep, ''];
    ...
    lines.push(`  • Generated on ${_now()} · ThreatLens`);
    lines.push('');
    lines.push(sep2);
  ...
  function _analystSummaryArticle(article, nvdData) {
    ...
    const lines = [sep, 'ANALYST SUMMARY — ThreatLens', sep, ''];
  ...
  function _analystSummaryIncident(incident) {
    const sep  = '═'.repeat(48);
    const sep2 = '─'.repeat(48);
    const lines = [sep, 'INCIDENT REPORT — ThreatLens', sep, ''];
  ...
  function _emailBriefArticle(article) {
    ...
    lines.push(sep);
    lines.push(`Auto-generated by ThreatLens · ${_now()}`);
    ...
    return {
      ...
      _ticketStub: {
        ...
        description: [
          ...
          '',
          '---',
          `*Auto-generated by ThreatLens on ${_now()}*`
